  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
        ...
        <div className="rounded-lg bg-gradient-to-br from-gray-900 to-black border border-orange-600/30 p-6 shadow-xl hover:shadow-2xl transition-shadow">
          <h3 className="text-lg font-bold text-orange-400 mb-2">Nový kritik</h3>
          <p className="text-gray-400 text-sm mb-4">Vytvořit účet pro dalšího kritika.</p>
          <Link href="/dashboard/critics/new" className="inline-block font-semibold text-orange-400 hover:text-orange-300 transition-colors">
            Otevřít →
          </Link>
        </div>
      </div>
